...
platform. `--tailscale` gets its own explicit, dedicated rejection message
rather than the generic "unknown option" one; see "Optional Tailscale
networking profile" > "Fedora WSL policy" for why.
