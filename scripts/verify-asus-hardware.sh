...
deprecated_wrapper "scripts/verify-asus-hardware.sh" \
  "platforms/fedora/scripts/verify.sh, which includes the hardware checks" \
  "platforms/fedora/scripts/verify-asus-hardware.sh"

exec "$repo_root/platforms/fedora/scripts/verify-asus-hardware.sh" "$@"
