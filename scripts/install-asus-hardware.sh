...
deprecated_wrapper "scripts/install-asus-hardware.sh" \
  "./install.sh --platform fedora --hardware MODEL" \
  "platforms/fedora/scripts/install-asus-hardware.sh"

exec "$repo_root/platforms/fedora/scripts/install-asus-hardware.sh" "$@"
