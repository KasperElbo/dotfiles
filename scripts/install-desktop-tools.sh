...
deprecated_wrapper "scripts/install-desktop-tools.sh" \
  "./install.sh --platform fedora --desktop-tools" \
  "platforms/fedora/scripts/install-desktop-tools.sh"

exec "$repo_root/platforms/fedora/scripts/install-desktop-tools.sh" "$@"
