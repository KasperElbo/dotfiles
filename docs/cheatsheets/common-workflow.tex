...
\cssection{Claude Code (optional AI profile)}
\begin{cskeys}{0.34\linewidth}
\csrow{cc}{claude with permission prompts disabled}
\end{cskeys}
\csnote{cc shadows the C compiler driver of the same name; command cc still reaches it, and scripts are unaffected because aliases apply only to interactive shells.}
